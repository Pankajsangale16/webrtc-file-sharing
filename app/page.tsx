    ...
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-[90%] max-w-2xl mx-auto px-4 py-8">
        <div className="glass-card p-8 rounded-3xl text-foreground transition-all duration-300">
          <h1 className="text-4xl md:text-5xl font-extrabold text-center drop-shadow-md tracking-wide mb-6 bg-gradient-to-r from-emerald-500 to-cyan-500 bg-clip-text text-transparent">
            🚀 WebRTC File Sharing
          </h1>
